...
APPS_DIR = BASE_DIR / "disease_surveillance_dashboard"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "disease_surveillance_dashboard.contrib.sites.migrations"}
...
ADMINS = [("""Princess Cheryl Asiedu-Donkor & Akua Dede Amofa""", "princess.donkor@ashesi.edu.gh")]
...
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "disease_surveillance_dashboard.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Disease Surveillance Dashboard API",
    "DESCRIPTION": "Documentation of API endpoints of Disease Surveillance Dashboard",
    "VERSION": "1.0.0",
